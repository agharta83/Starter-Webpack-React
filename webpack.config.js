/* === Ne pas oublier d'importer le style dans le fichier index.js === */
...
module.exports = {
  ...
  entry: {
    app: [
      // Styles
      './src/styles/main.scss', // A modifier selon le pré-processeur css
      // JS
      './src/index.js',
    ],
  },
  ...
  plugins: [
    ...
    // Assigne un type MIME aux liens injectés par HTML Webpack Plugin
    new LinkTypePlugin({
      '**/*.css': 'text/css',
    }),
